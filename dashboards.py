...
def info_ms(key, path):
    ...
    if my_file.is_file():
        ...
        content = {'type': 'dl-methods', 'datasets': [{'id': 'OWOtest9487', 'status': 'NG', 'describe': 'red'},{'id': 'OAOtest9487', 'status': 'OK', 'describe': 'red'}]}
    p = ""
...
# <h4 id='t1w1i2'>Image 2</h4><p><img src='./cow.jpg' alt='cow.jpg'></p>
    ...
    for filename in equal_lists:
        ...
        print("OpenCV resizes the image to base64 length : %d"%len(image_code))
        # print(image_code)
        tem_con_bar_c2 = "<li class='shape-ex1-list-thr-name listnonema'><span>" + filename + " - " + info_simple_ms(filename, up_ymal_path_key) + " <a href='#t1w2i" + filename + "' class='aright'>HERE</a></span></li>"

        tem_con_sides_m_2 = "<li><a href='#t1w2i" + filename + "' class='as'>" + filename + " - " + info_simple_ms(filename, up_ymal_path_key) + " </a></li>"
