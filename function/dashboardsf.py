...
def report_function_d(ymal_path, original_image, predict_folder, train_folder, html_path, pout):
    ...
    con_main_header_1 = "<body class='pagetop' onscroll='get()'><header class='topscheader'>Dashboard</header>"
