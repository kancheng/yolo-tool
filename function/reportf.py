...
def report_function(ymal_path, original_image, predict_folder, train_folder, html_path, pout):
...
# report_function(ymal_path, original_image, predict_folder, train_folder, html_path, pout)
